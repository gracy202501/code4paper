...
def plot_multiclass_roc_curve(true_labels, predicted_probabilities):
    ...
    # plt.savefig('pic/LL_Phys_hard2_R.png', format='png', dpi=300)
    # plt.savefig('pic/LL_Phys_hard2_R.pdf', format='pdf', dpi=300)
    # plt.savefig('pic/LL_Phys_hard2_R.eps', format='eps', dpi=300)
...
#         torch.save(net, 'pth/LL_Phys_hard2_model.pt')
#
...
# 测试最优模型
net = torch.load('pth/LL_Phys_hard2_model.pt')
...
# plt.savefig('pic/LL_Phys_hard2_C.png', format='png', dpi=300)
# plt.savefig('pic/LL_Phys_hard2_C.pdf', format='pdf', dpi=300)
# plt.savefig('pic/LL_Phys_hard2_C.eps', format='eps', dpi=300)
plt.show()