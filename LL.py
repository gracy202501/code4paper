...
def plot_multiclass_roc_curve(true_labels, predicted_probabilities):
    ...
    # plt.savefig('pic/LL_R.png', format='png', dpi=300)
    # plt.savefig('pic/LL_R.pdf', format='pdf', dpi=300)
    # plt.savefig('pic/LL_R.eps', format='eps', dpi=300)
...
class CombinedModel(nn.Module):
    def __init__(self, lstm_input_size1=3, lstm_hidden_size1=128, lstm_layers1=2,
        ...
        self.simple_nn = SimpleNN(input_dim=combined_input_dim)
    ...
    def forward(self, data):
        ...
        # 将拼接后的特征输入贝叶斯神经网络
        logits = self.simple_nn(combined_features)
        return logits
...
#         torch.save(net, 'pth/LL_model.pt')
#
...
# 测试最优模型
net = torch.load('pth/LL_model.pt')
...
# plt.savefig('pic/LL_C.png', format='png', dpi=300)
# plt.savefig('pic/LL_C.pdf', format='pdf', dpi=300)
# plt.savefig('pic/LL_C.eps', format='eps', dpi=300)
plt.show()